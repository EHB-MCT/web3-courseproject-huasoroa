  ...
  () => {
            ...
            case 'video':
                return (
                    <div>
                        ...
                        <input type='file' name='video' onChange={e => setVideo(e.target.files[0])} value={video} disabled={url!==''}/>
                    </div>
                )
            ...
            case 'audio':
                return (
                    <div>
                        ...
                        <input type='file' name='audio' onChange={e => setAudio(e.target.files[0])} value={audio} disabled={url!==''}/>
                    </div>
                    ) 
            default:
                break;
    ...
    return (
        <div>
            ...
            <h1>Your room tag is : #{props.id}</h1>
